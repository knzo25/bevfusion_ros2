...
//#pragma message("TensorRT version 1: " XSTR(TENSORRT_VERSION_MAJOR) "." XSTR(TENSORRT_VERSION_MINOR) "." XSTR(TENSORRT_VERSION_PATCH))
#pragma message("TensorRT version 2: " XSTR(NV_TENSORRT_MAJOR) "." XSTR(NV_TENSORRT_MINOR) "." XSTR(NV_TENSORRT_PATCH))
...
bool TrtCommon::setBindingDimensions([[maybe_unused]] const int32_t index, [[maybe_unused]] const nvinfer1::Dims & dimensions) const
{
#if (NV_TENSORRT_MAJOR * 1000) + (NV_TENSORRT_MINOR * 100) + (NV_TENSOR_PATCH * 10) < 10000
