...
{
  autoware::lidar_bevfusion::NonMaximumSuppression nms;
  autoware::lidar_bevfusion::NMSParams params;
  params.search_distance_2d_ = 1.0;
  params.iou_threshold_ = 0.2;
  params.nms_type_ = autoware::lidar_bevfusion::NMS_TYPE::IoU_BEV;
  params.target_class_names_ = {"CAR"};
  nms.setParameters(params);

  std::vector<autoware::lidar_bevfusion::DetectedObject> input_objects(4);
  ...
  std::vector<autoware::lidar_bevfusion::DetectedObject> output_objects = nms.apply(input_objects);
