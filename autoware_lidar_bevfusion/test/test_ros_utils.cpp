...
TEST(TestSuite, box3DToDetectedObject)
{
  ...
  {
    autoware::lidar_bevfusion::Box3D box3d;
    box3d.label = 0;  // CAR
    box3d.score = 0.8f;
    box3d.x = 1.0;
    box3d.y = 2.0;
    ...
    autoware::lidar_bevfusion::box3DToDetectedObject(box3d, class_names, obj);
