...
struct SparseGatherFunctor<tv::CPU, scalar_t, Index> {
  void operator()([[maybe_unused]] const tv::CPU& d, tv::TensorView<scalar_t> buffer,
...
struct SparseScatterAddFunctor<tv::CPU, scalar_t, Index> {
  void operator()([[maybe_unused]] const tv::CPU& d, tv::TensorView<scalar_t> outFeatures,
                  tv::TensorView<const scalar_t> buffer,
                  tv::TensorView<const Index> indices, int size, [[maybe_unused]] bool stable) {
