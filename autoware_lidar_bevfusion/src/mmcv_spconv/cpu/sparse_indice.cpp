...
#include "autoware/mmcv_spconv/common/utils/spconv/spconv/geometry.h"
...
struct CreateConvIndicePairFunctor<tv::CPU, Index, IndexGrid, NDim> {
  Index operator()([[maybe_unused]] const tv::CPU& d, tv::TensorView<const Index> indicesIn,
                   ...
                   const tv::SimpleVector<Index, NDim> outSpatialShape,
                    [[maybe_unused]] bool transpose, [[maybe_unused]] bool resetGrid) {
    if (transpose)
